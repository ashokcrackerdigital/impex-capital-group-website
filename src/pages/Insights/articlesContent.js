export const articlesContent = [
    {
        ...
        content: [
            ...
            {
                heading: "1. Jitters in the Housing Market",
                paragraphs: [
            ...
            {
                heading: "2. CORE FUNDAMENTALS REMAIN STRONG",
                paragraphs: [
            ...
            {
                heading: "3. Gen Y and Millennials are joining the workforce",
                paragraphs: [
            ...
            {
                heading: "4. Baby Boomers are aging but still have equity",
                paragraphs: [
    ...
    },
    {
        ...
        content: [
            ...
            {
                heading: "1. Net Operating Income (NOI)",
                paragraphs: [
            ...
            {
                heading: "2. Capitalization Rate (Cap Rate)",
                paragraphs: [
            ...
            {
                heading: "3. Internal Rate of Return (IRR)",
                paragraphs: [
            ...
            {
                heading: "4. Loan-to-Value Ratio (LTV)",
                paragraphs: [
            ...
            {
                heading: "5. Gross Rent Multiplier (GRM)",
                paragraphs: [
            ...
            {
                heading: "6. Debt Coverage Ratio (DCR)",
                paragraphs: [
            ...
            {
                heading: "9. Operating Expense Ratio (OER)",
                paragraphs: [
    ...
    },
    {
        ...
        content: [
            ...
            {
                heading: "So how should you as investors be getting ready? Invest in property.",
                paragraphs: [
            ...
            {
                heading: "Multifamily is in a Class by Itself",
                paragraphs: [
            ...
            {
                heading: "Period Of Recessions: How Long?",
                paragraphs: [
                    ...
                    "1. Set your sights on properties with higher cash flow rather than relying heavily on ones with significant appreciation. When you need to sell an investment based on appreciation income in a weak economy, it’s a losing proposition.",
                    "2. When it comes to possible rent increases, take into account the worst-case situation. Check the government cap on rent increases in the region where you plan to invest because allowable rent increases are a significant component of multifamily investing.",
                    "3. Obtain the profit and loss account to see how the property performed throughout the 2008 recession.",
                    "I am putting out a diversification plan that includes multifamily. Some people insure their gold, stock, and real estate investments."
                ]
            },
            {
                heading: "Recommendations for Buying Investment Properties",
                paragraphs: [
                    ...
                    "2. Consider cash flow: Maintaining cash flow as your primary concern is another guideline to assist you to make the greatest real estate deals. Consider the situation when you want to add a rental property to your portfolio during a recession. If so, look into homes with strong cash flow."
                ]
            },
            {
                heading: "Conclusion",
